...
public class QuestionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    {
        view.animate().alpha(value).scaleX(value).scaleX(value).setDuration(500).setStartDelay(100).setInterpolator(new DecelerateInterpolator()).setListener(new Animator.AnimatorListener() {
            @Override
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (value == 0)
                {
                    ...
                    {
                        case 0:
                            ((TextView)view).setText(questionList.get(quesNum).getQuestions());
                            break;
                        case 1:
                    ...
                    if (viewNum != 0)
                        ((Button)view).setBackgroundTintList(ColorStateList.valueOf(Color.parseColor("#207A23")));
